...
export type TSearchParamsConstructorProps<Filter = string> = {
  page?: number;
  per_page?: number;
  sort?: string | null;
...
export class SearchParams<Filter = string> extends ValueObject {
  ...
  protected _sort_dir: TSortDirection | null;
  protected _filter: Filter | null;

  constructor(props: TSearchParamsConstructorProps<Filter> = {}) {
    super();
  ...
  get sort_dir(): TSortDirection | null {
    return this._sort_dir;
  }

  private set sort_dir(value: TSortDirection | null) {
    if (!this.sort) {
      this._sort_dir = null;
      return;
    }
