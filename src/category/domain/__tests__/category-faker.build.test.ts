...
import { CategoryFakeBuilder } from "../category-faker.build";

describe("CategoryFakerBuilder Unit Tests", () => {
  const faker = CategoryFakeBuilder.aCategory();

  test("should throw error when any with methods has called", () => {
    expect(() => faker.category_id as any).toThrow(
  ...
  describe("name prop", () => {
    ...
    test("should be call the word method", () => {
      const chance = Chance();
  ...
  describe("created_at prop", () => {
    test("should throw error when any with methods has called", () => {
      expect(() => faker.created_at as any).toThrow(
